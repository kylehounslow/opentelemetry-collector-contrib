...
func openInferenceProcessor() *genaiNormalizerProcessor {
...
// BenchmarkNormalizeNoMatch benchmarks the no-op case where a span has no
// GenAI attributes (early exit path).
