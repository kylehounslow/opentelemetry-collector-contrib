...
Source mapping tables are populated in follow-up PRs; this PR provides the normalization machinery and configuration surface.

## Configuration

### Supported sources:

- `openinference` — [OpenInference](https://github.com/Arize-ai/openinference) instrumentation (mapping table populated in a follow-up PR)
